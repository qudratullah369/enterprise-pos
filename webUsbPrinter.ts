...
export async function printViaWebUsb(
  ...
  try {
    ...
    await dev.transferOut(endpointNumber, bytes)
    ...
    return {
      success: false,
      message: `WebUSB print failed: ${err?.message || err}`,
    }
  }
}
 ...
 */
export async function printEscPosBase64(base64: string): Promise<WebUsbPrintResult> {
